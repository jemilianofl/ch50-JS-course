...
console.log( null <= 0 ); // true null se convierte en 0
console.log( undefined <= 0 ); // false undefined se convierte en NaN
...
/*
    ...
    OP1 && OP2 Si OP1 es verdadero, se retorna la expansión de OP2.
    OP1 || OP2 Si OP1 es verdadero, se retorna la expansión de OP1.
