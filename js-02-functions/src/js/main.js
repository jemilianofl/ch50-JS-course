...
// Agregar el párametro nombre y mostrar "Hola Serch, soy una función declarada"
saludarConNombre("Serch");
...
const sumaDeDosNumeros = function (num1, num2) {
    return num1 + num2;
}
console.log( sumaDeDosNumeros( 3,6 ) ); // 9
...
/*
    ...
    Funciones que se autoinvoca, se pueden definir con funciones anónimas

    sintaxis:
    ( function (párametros) {} )( argumentos );
...
const rectanguloArea = function (base, altura) {
    return base * altura;
}

// Realizar una función flecha que calcule el área de un rectangulo
const rectangleArea = (height, width) => height * width;
console.log(`El área del rectángulo: ${rectangleArea(10, 5)} cm2`); // 50
...
console.log( saludarPersonaConDefaultParameters() ); // Hola Invitado/a, 

// Realizar una función que tenga de parámetros el nombre y cohorte
// Los valores por default de los párametros son nombre=participante cohorte="cohorte de Generation"
...
const saludarCohorte = (nombre = "participante", cohorte = "Generation") => `Hola ${nombre}, bienvenido/a a la cohorte de ${cohorte}`;
console.log( saludarCohorte() );
console.log( saludarCohorte( "Emiliano", "CH50" ) );
=======
 Las funciones permiten organizar, reutilizar y 
 estructurar el código. Su propósito principal es:
...
<<<<<<< HEAD
const ordenarNumerosSimplificados = ( numA, numB) => numA - numB;
const otrosNumeros = [ 1, 10, 3, 100, 5];
console.log( otrosNumeros.sort( ordenarNumerosSimplificados ) ); // [1, 3, 5, 10, 100]

const numerosDeLaSuerte = [7, 21, 14, 28, 35];
console.log( numerosDeLaSuerte.sort( (a,b) => a-b ) );
console.log( numerosDeLaSuerte.sort( function(a,b){return a-b} ) );
